    ...
    public partial class AddTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisteredCompanies", x => x.company_id);
                    table.ForeignKey(
                        name: "FK_RegisteredCompanies_Companies_company_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_RegisteredCompanies_company_id",
                        column: x => x.company_id,
